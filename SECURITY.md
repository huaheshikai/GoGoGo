...
团队和社区非常重视白梦玉中的安全问题。感谢您为负责任地披露您的发现所做的努力。
...
如果您发现了任何安全漏洞，请给 zcsexp@gmail.com 发送邮件。邮件标题为 `[SECURITY][白梦玉] xxxxx`, 内容格式如下所示：
...
- 白梦玉版本 / GoGoGo Version : 
- 系统版本 / OS Version : 

<!-- 请在上方描述出问题的白梦玉版本及使用的系统版本，然后删除该注释。 -->
